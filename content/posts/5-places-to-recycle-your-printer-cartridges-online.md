...
1. [Milner](https://milner.com/client-support-center/recycling-center): Accepts all ink and toner cartridges (both OEM and remanufactured). They stand by "we recycle any cartridge, regardless of manufacturer, with a zero-landfill" policy. Compensation for cartridges is not given out, though, if that is something you are looking for.
2. [Planet Green Recycle](https://www.planetgreenrecycle.com/pages/start-fundraising): Accepts all ink cartridges ("regardless of make, model or condition"), but not toner cartridges. They give compensation only for "Original Equipment Manufacturer (OEM) ink cartridges that are in good condition and can be remanufactured.
...
4. [US Recycling](https://uslaserinc.com/sell-to-us/): Accepts most ink and toner cartridges (both OEM and remanufactured). Has a program for schools, non-profits, and businesses as well.
